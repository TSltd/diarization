...
AUDIO1="audio/M_1011_13y10m_1.wav"   # 112 s
AUDIO2="audio/M_1017_11y8m_1.wav"    # 300 s

CXX="g++ -std=c++20 -O2"
SRCS_CORE="DiarizationEngine.cpp SpeakerClusterManager.cpp LabelSmoother.cpp TranscriptFormatter.cpp"
...
$CXX -I. -DDIARIZE_HAVE_MODEL \
  -I"$ORT_INC" \
  tests/integration_tests.cpp $SRCS_CORE WeSpeakerEcapaModel.cpp \
...
$CXX -I. -DDIARIZE_HAVE_MODEL \
  -I"$ORT_INC" \
  bench/diarization_bench.cpp $SRCS_CORE WeSpeakerEcapaModel.cpp \
  -L"$ORT_LIB" -Wl,-rpath,"$ORT_LIB" -lonnxruntime \
...
./tests/integration_tests "" test_two_speakers.wav \
...
if [[ -x tests/integration_tests_real ]]; then
  ./tests/integration_tests_real "$MODEL" test_two_speakers.wav \
...
./tests/acceptance_test test_two_speakers.wav --all-formats \
